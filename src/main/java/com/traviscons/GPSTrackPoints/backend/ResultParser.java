...
import com.traviscons.GPSTrackPoints.types.ENMEAMode;
import com.traviscons.GPSTrackPoints.types.EParity;
import com.traviscons.GPSTrackPoints.types.GSTObject;
import com.traviscons.GPSTrackPoints.types.IGPSObject;
import com.traviscons.GPSTrackPoints.types.ParseException;
...
import com.traviscons.GPSTrackPoints.types.subframes.ALMANACObject;
import com.traviscons.GPSTrackPoints.types.subframes.EPHEM1Object;
import com.traviscons.GPSTrackPoints.types.subframes.EPHEM2Object;
import com.traviscons.GPSTrackPoints.types.subframes.EPHEM3Object;
import com.traviscons.GPSTrackPoints.types.subframes.ERDObject;
import com.traviscons.GPSTrackPoints.types.subframes.HEALTH2Object;
import com.traviscons.GPSTrackPoints.types.subframes.HEALTHObject;
import com.traviscons.GPSTrackPoints.types.subframes.IONOObject;
...
public class ResultParser extends AbstractResultParser {
	...
	protected IGPSObject parseSUBFRAME(final JSONObject json) throws ParseException {
		...
		if (json.has("system_message")) {
			...
			System.err.println("ERROR: AbstractResultParser - Unknown subframe: " + json.toString());
		}
		gps = subframe;
		return gps;
	}
